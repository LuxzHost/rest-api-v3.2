document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        setContent('page', 'textContent', settings.name || "Luxz - Official  UI");
        setContent('wm', 'textContent', `© 2025 ${settings.apiSettings.creator}. All rights reserved.` || "© 2025 Luxz - Official . All rights reserved.");
        setContent('header', 'textContent', settings.name || "Luxz - Official  UI");
        setContent('name', 'textContent', settings.name || "Luxz - Official  UI");
